...
//     }
    ...
    // }
    return (
    <div className='flex flex-1 flex-col max-md:text-sm max-md:h-fit justify-around max-md:w-[95%]  w-[70%] backdrop-blur bg-[rgba(255,255,255,0.2)] border-richblack-20 border mx-auto py-4 rounded-3xl h-fit '>
        {data&&<div>
